...
public class FilmeSerieContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FilmeSerie>().HasData(
            ...
            new FilmeSerie { Id = 5, Titulo = "John Wick", Genero = new List<string> { "Ação", "Crime" }, Descricao = "John Wick é um lendário assassino de aluguel aposentado, lidando com o luto após perder o grande amor de sua vida. Quando um gângster invade sua casa, mata seu cachorro e rouba seu carro, ele é forçado a voltar à ativa e inicia sua vingança.", Imagem = "https://m.media-amazon.com/images/I/71+k2-r7vQL._UF894,1000_QL80_.jpg", Gostei = 23, NaoGostei = 2 }
        );

        modelBuilder.Entity<FilmeSerie>()
            .Property(fs => fs.Genero)
            .HasColumnType("text[]");
    }
